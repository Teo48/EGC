	...
	class Camera
	{
		public:
			...
			void RotateFirstPerson_OX(float angle)
			{
				...
				// Use glm::rotate()
				glm::vec4 tmp = glm::rotate(glm::mat4(1.f), angle, right) * glm::vec4(forward, 0);
			...
			void RotateFirstPerson_OY(float angle)
			{
				...
				glm::vec4 tmp = glm::rotate(glm::mat4(1.f), angle, glm::vec3(0, 1, 0)) * glm::vec4(forward, 0);
				forward = glm::normalize(glm::vec3(tmp));
				tmp = glm::rotate(glm::mat4(1.f), angle, glm::vec3(0, 1, 0)) * glm::vec4(right, 0);
				right = glm::normalize(glm::vec3(tmp));
				up = glm::normalize(glm::cross(right, forward));
			}
			...
			void RotateFirstPerson_OZ(float angle)
			{
				...
				glm::vec4 tmp = glm::rotate(glm::mat4(1.f), angle, glm::vec3(0, 1, 0)) * glm::vec4(right, 1);
				right = glm::normalize(glm::vec3(tmp));
				tmp = glm::rotate(glm::mat4(1.f), angle, forward) * glm::vec4(up, 0);
				forward = glm::normalize(glm::vec3(tmp));
				up = glm::normalize(glm::cross(right, forward));
			}
